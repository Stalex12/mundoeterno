...
function CustomCursor() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CustomCursor.useEffect": ()=>{
            const startLoading = {
                "CustomCursor.useEffect.startLoading": ()=>{
                    setIsVisible(true);
                    document.body.classList.add("is-loading-cursor");
                    const timer = setTimeout({
                        "CustomCursor.useEffect.startLoading.timer": ()=>{
                            setIsVisible(false);
                            document.body.classList.remove("is-loading-cursor");
                        }
                    }["CustomCursor.useEffect.startLoading.timer"], 2500) // Duración de 2.5 segundos
                    ;
                    return timer;
                }
            }["CustomCursor.useEffect.startLoading"];
...
_s(CustomCursor, "3z+ZbYjssY+HsxJ4ub8xI/sTlFg=", false, function() {
    return [
...
//# sourceMappingURL=_791b3fe5._.js.map