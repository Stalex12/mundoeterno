...
"[project]/components/cursor-loader.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CursorLoader.useEffect": ()=>{
            ...
            const timer = setTimeout({
                "CursorLoader.useEffect.timer": ()=>{
                    document.body.classList.remove("page-loading");
                }
            }["CursorLoader.useEffect.timer"], 1500);
            // Limpiar el timer si el componente se desmonta
            return ({
                "CursorLoader.useEffect": ()=>clearTimeout(timer)
            })["CursorLoader.useEffect"];
        }
    }["CursorLoader.useEffect"], [
        pathname,
...
_s(CursorLoader, "MQ+fdIBsK99GSZwlqslBov8Yc/s=", false, function() {
    return [
...
_c = CursorLoader;
var _c;
__turbopack_context__.k.register(_c, "CursorLoader");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function CustomCursor() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CustomCursor.useEffect": ()=>{
            ...
            const handleMouseUp = {
                "CustomCursor.useEffect.handleMouseUp": (e)=>{
                    if (cursorRef.current) {
                        const x = e.clientX - 40;
                        const y = e.clientY - 40;
    ...
    if (("TURBOPACK compile-time value", "object") !== "undefined" && window.matchMedia("(hover: none)").matches) {
        return null;
    }
...
_s(CustomCursor, "Q1IOyFrqF8JvQNsFiKvnBBawPDY=");
_c = CustomCursor;
var _c;
...
//# sourceMappingURL=_918c6754._.js.map